...
from web_project.views.mailings import MailingListView, MailingCreateView, MailingDetailView, MailingUpdateView, \
    MailingDeleteView
from web_project.views.messages import MessageListView, MessageCreateView, MessageDetailView, MessageUpdateView, \
    MessageDeleteView

from web_project.views.recipients import RecipientCreateView, RecipientDetailView, \
    RecipientUpdateView, RecipientDeleteView, RecipientListView
